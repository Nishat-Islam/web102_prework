...
function filterUnfundedOnly() {
    ...
    let notFunded = GAMES_JSON.filter((games) => {
...
let NotFundedDisplay = NotFunded.length;

// create a string that explains the number of unfunded games using the ternary operator
let DisplayStr = NotFundedDisplay == 1 ? "game" : "games";

// create a new DOM element containing the template string and append it to the description container

const gameInfo = document.createElement("p");
gameInfo.innerHTML = `A total of $ ${totalRaised.toLocaleString('en-US')} has been raised for 11 games. Currently, ${NotFundedDisplay} ${DisplayStr}
remain unfunded. We need your help to fund these amazing games!`;
descriptionContainer.append(gameInfo);
